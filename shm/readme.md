...
The same tools that can be used against you can also defend you. When more of us use these tools, when they become the norm, we build compounding network effects. It's easier to go your own way when that's just what people do. Open protocols, running your own communications -- these only become possible when we trust our tools. The only way to really trust them is to put our hands on them and understand them.
